...
export const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    shortDesc:
      "Comprehensive moving solutions for flats, houses, and countryside estates across the UK.",
    fullDesc:
      "Our flagship house removal service takes the stress out of moving day. We supply floor covers, padded mattress bags, furniture blankets, and TV transit crates as standard.",
    iconName: "Home",
    features: [
  ...
  },
  {
    ...
    shortDesc: "Flexible, affordable transport...",
    fullDesc: "Need a fast, cost-effective option...",
    iconName: "Truck",
    imageUrl: manVan,
    features: [
      "Choice of 1, 2 or 3 active helpers",
      "Fully equipped with straps, tail lift & blankets",
      "Flexible booking slots (same day available)",
      "Ideal for IKEA pickups, single sofas & student moves",
  ...
  },
  {
    ...
    shortDesc:
      "Minimized downtime commercial moves for offices, retail spaces, and tech hubs.",
    fullDesc:
      "Keep your business running without interruption. We offer out-of-hours, evening, and weekend commercial moves complete with IT equipment crate packing.",
    iconName: "Building2",
    features: [
  ...
  },
  {
    ...
    shortDesc:
      "Full house packing, fragile-only wrapping, and eco-friendly moving box supply.",
    fullDesc:
      "Let our trained packers wrap and box your belongings the day before your move using double-walled heavy duty eco-boxes and acid-free tissue paper.",
  ...
  },
  {
    ...
    shortDesc:
      "24/7 CCTV monitored climate-controlled storage units with direct collection.",
    fullDesc:
      "Transitioning between properties or downsizing? We load directly into clean, secure storage containers at our nationwide facilities and redeliver when ready.",
    iconName: "Warehouse",
    features: [
  ...
  },
  {
    ...
    shortDesc:
      "Dedicated door-to-door removals across England, Scotland, Wales, and Northern Ireland.",
    fullDesc:
      "Relocating to another corner of the UK? Enjoy direct, dedicated vehicle transport with live GPS tracking so your items never mix with other loads.",
    iconName: "MapPin",
    features: [
...
export const TESTIMONIALS_DATA: Testimonial[] = [
  {
    ...
    date: "July 2026",
    quote:
      "Affordable Moves were outstanding from initial estimate to final box unpacked! The crew arrived 10 minutes early, protected our oak flooring, and dismantled our heavy wardrobes effortlessly. Best removal experience we have ever had in the UK!",
    verified: true,
  },
  {
    id: "2",
    ...
    date: "June 2026",
    quote:
      "Incredible value for money. No hidden fees or sudden extra charges on moving day. The team wrapped our OLED TV in a custom transit crate and had everything loaded in under two hours. Highly recommended!",
    verified: true,
  },
  {
    id: "3",
    ...
    date: "June 2026",
    quote:
      "We moved our entire IT office over a Saturday to avoid client interruption. The crew handled all monitor crates, desk frames, and server racks with extreme care. Monday morning we were 100% operational!",
    verified: true,
  },
  {
    id: "4",
    ...
    date: "May 2026",
    quote:
      "The packing service was worth every single penny. Two delightful packers came the day before, boxed up all my glassware and books with supreme care, and on move day everything went smoothly.",
    verified: true,
  },
];
...
export const FAQS_DATA: FAQItem[] = [
  {
    ...
    answer:
      "Our pricing is transparent and calculated based on property size/volume of goods, distance between postcodes, access (floors/stairs/lifts), crew size required, and optional services like full packing or dismantle/reassembly. Use our Moving Cost Estimator on this site for an instant realistic guide.",
  },
  {
    id: "f2",
    category: "insurance",
    ...
    answer:
      "Yes! Every move with Affordable Moves includes up to £50,000 Goods in Transit cover and £5,000,000 Public Liability Insurance as standard. Additional cover limits can be arranged for high-value antiques or art collections.",
  },
  {
    id: "f3",
    category: "general",
    ...
    answer:
      "We recommend booking 2 to 4 weeks before your intended moving date, especially for Fridays and end-of-month peak periods. However, we also keep emergency vehicles available for short-notice or same-week moves!",
  },
  {
    id: "f4",
    category: "packing",
    ...
    answer:
      "Yes! If you select our packing service or order a box bundle, we deliver double-walled heavy-duty boxes, wardrobe cartons with hanging rails, bubble wrap, tape, and acid-free wrapping paper directly to your door prior to move day.",
  },
  {
    id: "f5",
    category: "general",
    ...
    answer:
      "We understand estate agent key releases can sometimes be delayed on completion day. Our team provides key delay protection and will comfortably wait with your loaded vehicle until keys are released.",
  },
  {
    id: "f6",
    category: "general",
    ...
    answer:
      "Yes! Our movers carry a full toolkit and can dismantle bed frames, dining tables, and wardrobes at your pickup location and reassemble them in your designated rooms at the new property.",
  },
];
...
export const GALLERY_DATA: GalleryItem[] = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=800",
    caption:
      "Our clean, liveried Luton vans equipped with tail lifts and floor protection mats.",
  },
  {
    id: "g2",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800",
    caption:
      "Individual acid-free tissue wrapping for delicate glassware and porcelain.",
  },
  {
    id: "g3",
    ...
    caption:
      "Thick padded blankets and quilted covers securing sofas and wooden furniture.",
  },
  {
    id: "g4",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1590247813693-5541d1c609fd?auto=format&fit=crop&q=80&w=800",
    caption:
      "Spacious, dry, and CCTV-monitored storage containers available for short & long term.",
  },
  {
    id: "g5",
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800",
    caption:
      "Systematic crate tagging and IT equipment handling for seamless business moves.",
  },
  {
    id: "g6",
...
export const BLOG_POSTS_DATA: BlogPost[] = [
  {
    ...
    date: "July 15, 2026",
    summary:
      "Stay organized during your property move with this step-by-step week-by-week timeline covering utility notifications, council tax transfers, and packing milestones.",
    imageUrl:
  ...
  },
  {
    ...
    date: "June 28, 2026",
    summary:
      "Discover professional techniques used by master packers to safeguard delicate heirlooms, crystal, and artwork during transit.",
    imageUrl:
      "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800",
