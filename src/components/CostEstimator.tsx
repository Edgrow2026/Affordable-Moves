...
export const CostEstimator: React.FC<CostEstimatorProps> = ({
  ...
  const [propertyType, setPropertyType] =
    useState<MoveEstimate["propertyType"]>("2-bed-house");
  const [distanceMiles, setDistanceMiles] = useState<number>(35);
  const [floorAccess, setFloorAccess] =
    useState<MoveEstimate["floorAccess"]>("ground");
  ...
  return (
    <section
      id="estimator"
      className="py-20 bg-[#FAF8F4] border-b border-[#E6DAC4]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-[#666666] text-sm mt-3">
            Get an instant, realistic budget range for your upcoming move in
            under 30 seconds. No obligation, no hidden surprises.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-[#E6DAC4] space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setPropertyType(item.id as MoveEstimate["propertyType"])
                    }
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-sm font-bold text-[#5F7355]">
                  {distanceMiles} Miles
                </span>
              </div>
              <input
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFloorAccess(item.id as MoveEstimate["floorAccess"])
                    }
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  {
                    id: "packing",
                    label: "Full Fragile Packing Service",
                    desc: "+ Glassware & China protection",
                  },
                  {
                    id: "dismantle",
                    label: "Furniture Dismantle & Reassembly",
                    desc: "+ Beds, wardrobes, tables",
                  },
                  {
                    id: "storage",
                    label: "Include Secure Storage",
                    desc: "+ Climate-controlled holding",
                  },
                  {
                    id: "boxesBundle",
                    label: "Recyclable Box Bundle Delivery",
                    desc: "+ 25 heavy duty eco cartons",
                  },
                ].map((addon) => {
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-start space-x-3 p-3 rounded-xl border cursor-pointer transition-all ${
                        isChecked
                          ? "bg-[#E6DAC4]/30 border-[#5F7355]"
                          : "bg-[#FAF8F4] border-[#E6DAC4]"
                      }`}
                    >
                      <input
                        type="checkbox"
                      ...
                      />
                      <div>
                        <span className="text-xs font-semibold text-[#475841] block">
                          {addon.label}
                        </span>
          ...
          <div className="lg:col-span-5 space-y-4 sticky top-28">
            <div className="bg-[#475841]/75 backdrop-blur-xl text-white rounded-2xl p-6 sm:p-8 shadow-2xl border border-white/20 space-y-6">
              {" "}
              ...
              <div>
                <span className="text-xs text-[#E6DAC4] block">
                ...
                <div className="flex items-baseline space-x-2 mt-1">
                  ...
                  <span className="text-xs text-[#CDBA96] font-medium">
                    + VAT
                  </span>
                </div>
                <p className="text-[11px] text-[#E6DAC4] mt-1">
                  Includes fuel, transit insurance, protective blankets & floor
                  runners.
                </p>
              </div>
              ...
              <div className="bg-[#5F7355]/40 rounded-xl p-4 border border-[#8C9B80]/40 space-y-2 text-xs">
                <div className="flex justify-between text-[#E6DAC4]">
                  ...
                  <span className="font-semibold text-white">
                    {calculation.crewSize}-Man Professional Team
                  </span>
                </div>
                <div className="flex justify-between text-[#E6DAC4]">
                  <span>Vehicle Required:</span>
                  <span className="font-semibold text-white">
                    {calculation.crewSize > 3
                      ? "2x Luton Vans (Tail-Lift)"
                      : "Luton Van (3.5t Tail-Lift)"}
                  </span>
                </div>
                <div className="flex justify-between text-[#E6DAC4]">
                ...
                <div className="flex justify-between text-[#E6DAC4]">
                  ...
                  <span className="font-semibold text-[#CDBA96]">
                    Up to £50,000
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <span className="whitespace-nowrap">
                  Lock In Estimate & Get Official Quote
                </span>
              ...
              <div className="flex items-center space-x-2 text-[11px] text-[#E6DAC4]">
                ...
                <span>
                  Price Match Guarantee against any written BAR accredited
                  removal quote.
                </span>
              </div>
            </div>
